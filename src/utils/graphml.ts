...
export function graphmlNodeToXml(
	...
	return `\
        <node id="${data.id}">
            ...
            <data key="d6">
                <y:ShapeNode>
                    <y:Geometry height="30.0" width="99.0" x="${data.x}.0" y="${data.y}.0"/>
